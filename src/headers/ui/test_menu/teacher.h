...
namespace ui::test_menu
{
    ...
    {
    public:
        void show(std::string test_name, std::string username, size_t amount_of_questions, std::unordered_map<std::string, int> users_points,
                  std::string selected_answer) override;
    };
}
